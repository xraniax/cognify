            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                <div className="group">
                    ...
                    <h1 className="text-5xl font-black text-gray-900 tracking-tight lg:tracking-tighter mb-2">
                        System <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-600 drop-shadow-sm">Trash</span>
                    </h1>
                    <p className="text-gray-500 font-medium text-lg mt-2">View deleted materials and restore them to their original subjects.</p>
                </div>
            </div>
