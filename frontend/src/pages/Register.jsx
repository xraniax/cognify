            ...
            <div className="w-full max-w-sm border border-gray-200 p-6 rounded shadow-sm bg-white">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            type="text"
                            className={`input-field ${err.fields.name ? 'border-red-500 focus:ring-red-200' : ''}`}
                            placeholder="Your name here.."
                            required
                            value={formData.name}
                            onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                        />
                        {err.fields.name && <p className="text-xs text-red-500 mt-1">{err.fields.name}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            type="email"
                            className={`input-field ${err.fields.email ? 'border-red-500 focus:ring-red-200' : ''}`}
                            placeholder="name@example.com"
                            required
                            value={formData.email}
                            onChange={(e) => setFormData({ ...formData, email: e.target.value })}
                        />
                        {err.fields.email && <p className="text-xs text-red-500 mt-1">{err.fields.email}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`input-field pr-10 ${err.fields.password ? 'border-red-500 focus:ring-red-200' : ''}`}
                                required
                        ...
                        {err.fields.password && <p className="text-xs text-red-500 mt-1">{err.fields.password}</p>}
                    </div>
